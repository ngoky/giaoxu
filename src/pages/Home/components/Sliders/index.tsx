...
const SliderView = (props: any) => {
  ...
  const beforeChange = (_: any, newIndex: React.SetStateAction<number>) => {
    setIndex(newIndex);
  };
  const dispatch = useAppDispatch();
  const topPost = useAppSelector((state: any) => {
...
export const Slider = connect(mapState, actionCreators)(SliderView);
